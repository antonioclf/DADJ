...
export const CATALOG_ITEMS = [
  { name: '4º A Completo', type: '4º A' as InventoryItemType, price: 389.00, color: 'Padrão', discount: 6.5 },
  { name: 'Calça 4º A', type: '4º A' as InventoryItemType, price: 199.00, color: 'Padrão', discount: 5 },
