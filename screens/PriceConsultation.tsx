...
const PriceConsultation: React.FC<PriceConsultationProps> = ({ inventory, onBack }) => {
    ...
    const getPriority = (name: string) => {
        ...
        if (n.includes('price list')) return 0; // Just in case
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-slate-50/50 dark:bg-slate-800/30">
                                    ...
                                    <th className="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Cartão</th>
                                </tr>
                            </thead>
